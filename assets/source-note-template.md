...
## Key takeaways
- Durable takeaway 1 (with provenance)
- Durable takeaway 2 (with provenance)
- Durable takeaway 3 (with provenance)
...
- If nothing is uncertain, state why the source is unusually clean or authoritative

## Wiki updates triggered by this source
- Updated:
- Created:
- Cross-links:
